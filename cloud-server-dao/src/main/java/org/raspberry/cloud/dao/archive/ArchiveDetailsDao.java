...
public interface ArchiveDetailsDao extends JpaRepository<ArchiveDetails, Long> {
	...
	@Query("SELECT entity FROM ArchiveDetails entity WHERE entity.idUser = :idUser AND entity.idType = :idType")
	public List<ArchiveDetails> findAllByType(@Param("idUser") Long idUser, @Param("idType") Long idType);
